...
class CrawlingRobot:
    ...
    def draw(self, stepCount, stepDelay):
        ...
        self.velavg_msg = self.canvas.create_text(650,190,text=velMsg, fill='black')
        self.vel_msg = self.canvas.create_text(450,190,text=velocityMsg, fill='black')
        self.pos_msg = self.canvas.create_text(250,190,text=positionMsg, fill='black')
        self.step_msg = self.canvas.create_text(50,190,text=stepMsg, fill='black')
